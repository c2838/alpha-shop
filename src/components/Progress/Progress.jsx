    ...
    <section className={progressStyle.progressContainer}>
      ...
      {status === "address" && (
        <section className={progressStyle.btnGroupFirst} data-phase="address">
          <button
            className={progressStyle.nextBtn}
            onClick={() => onProgress("shipping")}
          >
            下一步
            <img
              src={rightArrow}
      ...
      {status === "shipping" && (
        <section className={progressStyle.btnGroupSecond} data-phase="shipping">
          <button
            className={progressStyle.prevBtn}
            onClick={() => onProgress("address")}
          >
            <img
              src={leftArrow}
      ...
      {status === "checkout" && (
        ...
        >
          ...
          <button className={progressStyle.nextBtn} onClick={onSubmit}>
            確認下單
          </button>
        </section>
      )}
